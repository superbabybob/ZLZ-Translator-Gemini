...
- คลิกขวา = เมนู: **ตั้งค่าคีย์และบัญชี...** (มีปุ่มพาไปหน้าขอคีย์ Gemini และช่องวางคีย์ ไม่ต้องเปิดไฟล์เอง), น้ำเสียงตอนตอบ, เปิด/ปิด Discord app, **เปิดอัตโนมัติเมื่อเข้า Windows**, คลังศัพท์, จำนวนครั้งที่ใช้วันนี้, ออกจากโปรแกรม
